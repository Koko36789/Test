...
keys=[
    key((l//4)-50,judgeline_y-125,100,25,(255, 0, 0),pygame.K_g),
    key((l//4)-50,judgeline_y-125,100,25,(255, 0, 0),pygame.K_g),
    key((3*l//4)-50,judgeline_y+100,100,25,(255, 0, 0),pygame.K_h),
    key((3*l//4)-50,judgeline_y+100,100,25,(255, 0, 0),pygame.K_h),
    ]
keys_g=[
    key((l//4)-50,judgeline_y-100,100,50,(0, 255, 0),pygame.K_g),
    key((3*l//4)-50,judgeline_y-100,100,50,(0, 255, 0),pygame.K_h),
    key((l//4)-50,judgeline_y+50,100,50,(0, 255, 0),pygame.K_g),
    key((3*l//4)-50,judgeline_y+50,100,50,(0, 255, 0),pygame.K_h),    
       ]

keys_p=[
    key((l//4)-50,judgeline_y-50,100,100,(0, 0, 255),pygame.K_g),
    key((3*l//4)-50,judgeline_y-50,100,100,(0, 0, 255),pygame.K_h),      
       ]
def menureadlevel():
...
def readchart(chart):
    ...
    for i in range (0,len(a)):
       ...
       #spawn notes as rectangles 
        if a[i][1]==0:
            rects.append(pygame.Rect((l//4)-25,(a[i][0]-judgeline_y)/-1,50,25))
        elif a[i][1]==1:
            rects.append(pygame.Rect((3*l//4)-25,(a[i][0]-judgeline_y)/-1,50,25))
    f.close()
...
while run:    # infinite loop
    ...
    while playsong and pygame.time.get_ticks()<=(timing_list[note_count-1][0]+7000+start_t):
        ...
        pygame.draw.rect(win,linec,pygame.Rect(0,770,w,1))
